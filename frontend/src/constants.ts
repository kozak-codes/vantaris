...
import { BIOME_CONFIGS as SHARED_BIOME_CONFIGS, GLOBE_CONFIG as SHARED_GLOBE_CONFIG, FOG_CONFIG as SHARED_FOG_CONFIG, CAMERA_CONFIG as SHARED_CAMERA_CONFIG, CELL_COLOR_LERP as SHARED_CELL_COLOR_LERP } from '@vantaris/shared/constants';
